...
<link rel="stylesheet" href="{{ asset('resources/assets/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}">
...
<script src="{{ asset('resources/assets/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js') }}" ></script>
