...
@section('content')
<link rel="stylesheet" href="{{ asset('resources/assets/bower_components/bootstrap-slider/slider.css') }}">
...
<!-- Bootstrap slider -->
<script src="{{ asset('resources/assets/bower_components/bootstrap-slider/bootstrap-slider.js') }} "></script>
<script>
$(function () {
    /* BOOTSTRAP SLIDER */
    $('.slider').slider()
