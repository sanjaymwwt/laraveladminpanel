...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="box box-body">
                <div class="col-md-6">
                    <h4><i class="fa fa-file"></i> &nbsp; Video Upload Example</h4>
                </div>  
            </div>
        </div>
    </div>
    <div class="box">
        ...
        <div class="box-body table-responsive">
            ...
            <p><small class="text-success">Allowed Types: mp4</small></p>
            {!! Form::close() !!}       
...
<script type="text/javascript">
    ...
    function deleteVideo(e) {        
        ...
        if (confirm("Are you sure want to delete this Video?")) {           
            $.ajax({
                data: {img: image,type:'video', _token: CSRF_TOKEN},
                type: 'get',
                url: 'DeleteImage',
                async: true,
                success: function (output) {
                    ...
                    $('.succClass').html('Video deleted Successfully!');
                    $('#uploadedData').hide();
                }
            });
        } else {
    ...
    $(document).ready(function (e) {
        $('#submit').submit(function (e) {
            ...
            e.preventDefault();
            $.ajax({
                url: 'videofile_upload', // point to server-side controller method                
