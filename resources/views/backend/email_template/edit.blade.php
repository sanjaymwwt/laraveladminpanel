        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body my-form-body">
                    ...
                    {{ Form::open(['route' => ['email_templates.update', $email['id']],  'method' => 'POST','class' => 'form-horizontal']) }}                                  
                    <div class="form-group"> 
                        {!! Form::label('email_template_for', 'Email Title *', ['class' => 'col-sm-2 control-label']) !!}
                        <div class="col-sm-9">
                            {!! Form::text('email_template_for', $email['email_template_for'], ['class' => 'form-control', 'size' => 64, ]) !!}
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('email_template_subject', $email['email_template_subject'], ['class' => 'form-control', 'size' => 64, ]) !!}
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-9">
                            <?php $body = base64_decode($email['email_template_body']);?>
                            {!! Form::textarea('email_template_body', $body, ['class' => 'form-control',]) !!}
                            <span class="error"><?php echo $errors->first('email_template_body'); ?></span>
                        </div>
                    </div>
                    <div class="form-group">                         
                        <div class="col-sm-9">
                            {!! Form::hidden('identifier', null, ['class' => 'form-control', 'size' => 64,'id' => 'identifier' ]) !!}
