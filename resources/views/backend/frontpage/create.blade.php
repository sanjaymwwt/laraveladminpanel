        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body my-form-body">
                    ...
                    {!! Form::open([
                    'route' => 'front_pages.store',
                    'class' => 'form-horizontal'
                    ]) !!}
                    <div class="form-group"> 
                        {!! Form::label('page_name', 'Page Name *', ['class' => 'col-sm-2 control-label']) !!}
                        <div class="col-sm-9">
                            {!! Form::text('page_name', null, ['class' => 'form-control', 'size' => 64, ]) !!}
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-9">
                            ...
                            echo Form::select('target', $optionArr, '', array('class' => 'form-control'));
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-9">
                            ...
                            echo Form::select('url_type', $urlArr, '', array('class' => 'form-control','id' => 'type'));
                    ...
                    <div class="form-group internalmainDiv"> 
                        ...
                        <div class="col-sm-9">
                            <textarea name="page_description" id="page_description"></textarea>
                    ...
                    <div class="form-group urlmainDiv"> 
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('url', null, ['class' => 'form-control', 'size' => 64, ]) !!}
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-9">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="page_status" value="0" checked="checked">
                                    Active
                                </label>
                                &nbsp;&nbsp;
                                <label>
                                    <input type="radio" name="page_status" value="1">
                                    Inactive
                                </label>
                            </div>
